    ...
    <div class="wrapper d-flex">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="{{ url('/') }}" class="navbar-brand mx-4 mb-3 d-flex">
                    <img src="{{ asset('logo-no-bg.png') }}" style="width: 50px; height: 50px;" alt="Covid-19">
                    <h3 class="mt-2" style="color:#218ccd;">Covid-19</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ url('admin/add-vaccine') }}" class="nav-item nav-link">
                        <i class="fas fa-plus me-2"></i>Add Vaccine
                    </a>
                    <a href="{{ url('admin/vaccine-list') }}" class="nav-item nav-link">
                        <i class="fas fa-list me-2"></i>Vaccine List
                    </a>
                    <a href="{{ url('home') }}" class="nav-item nav-link">
                        <i class="fas fa-users me-2"></i>User List
                    </a>
                    <a href="{{ url('admin/hospital-list') }}" class="nav-item nav-link">
                        <i class="fas fa-hospital me-2"></i>Hospital List
                    </a>
                    <a href="{{ url('admin/patient-list') }}" class="nav-item nav-link">
                        <i class="fas fa-user me-2"></i>Patient List
                    </a>
                    <a href="{{ url('admin/appointment-list') }}" class="nav-item nav-link">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light d-flex sticky-top px-4 py-0">
                ...
                <a href="{{ url('/') }}" class="navbar-brand  d-lg-none ms-4">
                    <h1 class="mt-2" style="color:#218ccd;">
                        </class> <img src="{{ asset('logo-no-bg.png') }}" style="width: 50px; height: 50px;"
                            alt="Covid-19">
                        Covid-19</h1>
                </a>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            Copyright &copy; 2024 <a href="{{url('/')}}">Covid-19</a>, All Right Reserved.
                        </div>
                    </div>
                </div>
            </div>
